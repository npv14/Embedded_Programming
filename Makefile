...
bounce.o: bounce.c bounce.h
	$(CC) -c $(CFLAGS) $< -o $@
	
receive_task.o: receive_task.c receive_task.h
	$(CC) -c $(CFLAGS) $< -o $@

message_task.o: message_task.c message_task.h
	$(CC) -c $(CFLAGS) $< -o $@
	


# Link: create ELF output file from object files.
game.out: game.o system.o display.o pacer.o ledmat.o timer.o navswitch.o bar.o ir_uart.o usart1.o timer0.o prescale.o font.o tinygl.o led.o bounce.o receive_task.o message_task.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
